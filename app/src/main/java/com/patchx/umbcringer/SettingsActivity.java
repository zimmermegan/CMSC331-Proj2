...
/**
 * Created by Grace Chandler on 12-4-14
 *
 * General notes:
 *
 * This activity was autogenerated by android studio. Because of this there is a little bit of superfluous code
 * instead of deleting it, I left it in case for future versions, other basic settings can be easily added. This was my main portion of
 * the code that I worked on personally, and it was very interesting to learn how SharedPreferences works.
 * 
 * any questions should go to gchan1@umbc.edu
 */
...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        //eventually this will sync account to peoplesoft
     ...
     */
    //most of this portion isn't used, it was automatically created by android studio
    ...
    //This makes each setting have a summary
